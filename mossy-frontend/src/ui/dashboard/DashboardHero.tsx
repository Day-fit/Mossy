    ...
    return (
        <section className="flex flex-col lg:flex-row lg:h-[90vh] gap-8 px-4 py-2 overflow-x-hidden">
            ...
            >
                ...
                >
                    <div className="h-full rounded-md shadow-card bg-surface-card">
                ...
                <motion.div className="flex-1 min-h-0" variants={childVariants}>
                    <div className="h-full rounded-md shadow-card bg-surface-card p-10 flex overflow-x-auto gap-5">
                        {areVaultsLoading ? (
                            ...
                            <div className="w-full h-full flex flex-col items-center justify-center text-center type-body-sm text-fg-muted gap-3">
                            ...
                            <div className="w-full h-full flex flex-col items-center justify-center text-fg-muted type-body-sm gap-3">
                                <p>No vaults yet.</p>
                                <Button
                                    type="button"
                                    className="px-4 py-2 type-button-sm"
